					...
					<div className="offCanvas__side-info mb-30">
						<div className="contact-list mb-30">
							...
							<div className="mb-3">
								...
								<p className="mb-0">+254-746-952-861</p>
							</div>
							<div className="mb-3">
								<span className="text-400 fs-5">Email</span>
								<p className="mb-0">cleavon@cleavon.ke</p>
							</div>
							<div className="mb-3">
								<span className="text-400 fs-5">Teams</span>
								<p className="mb-0">cleavonsurumo</p>
							</div>
							<div className="mb-3">
								<span className="text-400 fs-5">Address</span>
								<p className="mb-0">Embassy house, Nairobi</p>
							</div>
						</div>
						<div className="contact-list">
							<p className="text-400 fs-5 mb-2">Social</p>
							<div className="d-md-flex d-none gap-3">
								<a href="https://www.facebook.com/cleavonsurumo/" target="_blank">
								...
								<a href="https://github.com/cleavonsurumo" target="_blank">
