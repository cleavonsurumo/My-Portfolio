								...
								<div className="resume-card-body">
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												<p className="fw-extra-bold text-linear-1 mb-2">2024-202025</p>
												<h5>Certification in Data Analytics With Power BI</h5>
												<p className="text-300 mb-0">Moringa  School</p>
											</div>
									...
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												...
												<h5>Certification in Digital Customer Service</h5>
												<p className="text-300 mb-0">Generation Kenya</p>
											</div>
									...
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												...
												<h5>Certification in Wordpress Dev</h5>
									...
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												<p className="fw-extra-bold text-linear-1 mb-2">2018-2020</p>
												<h5>Certification in Information & Communication Technology</h5>
												<p className="text-300 mb-0">Mount Kenya University</p>
											</div>
							...
							<div className="resume-card p-lg-6 p-4 h-100">
								...
								<div className="resume-card-body">
									<div className="resume-card-item px-4 py-3 mt-5">
										...
										<h5>Data Analyst</h5>
										<p className="text-300 mb-0">Quarser Org</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">2022 - 2024</p>
										<h5>ICT consultant</h5>
										<p className="text-300 mb-0">Quarser Org</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">2021- Present</p>
										<h5>Freelance Wordpress Deeloper</h5>
										<p className="text-300 mb-0">Self-Employed</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-4">
										<p className="fw-extra-bold text-linear-1 mb-2">June 2021 - Aug 2021</p>
										<h5>ICT Attache</h5>
										<p className="text-300 mb-0">The National Treasury</p>
									</div>
								</div>
							</div>
						</div>
