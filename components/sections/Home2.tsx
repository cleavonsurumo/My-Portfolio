							...
							<div className="row align-items-end py-60">
								...
								<div className="col-lg-6 mx-lg-auto col-md-12">
									<div className="p-lg-0 p-md-8 p-3">
										<div className="text-secondary-2 d-flex align-items-baseline">
											<span className="text-secondary-2">&lt;span&gt;</span>
											<span className="typewriter text-dark fs-6 fw-medium">Hello, I'm Cleavon</span>
											<span className="text-secondary-2">&lt;/span&gt;</span>
										</div>
										<h1 className="fs-50 my-3">Senior <span className="text-linear-4">{'{'}Wordpress{'}'}</span>Web designer &amp; developer<span className="flicker">_</span></h1>
										<p className="mb-6 text-secondary-2">&lt;p&gt;<span className="text-dark">With expertise in cutting-edge technologies such as</span> <span className="text-secondary-2">Elementor </span>, <span className="text-secondary-2">Woocommerce</span>, <span className="text-secondary-2">Divi</span>, and <span className="text-secondary-2">Gutenburg</span><span className="text-dark">... I deliver web solutions that are both innovative and robust.</span>&lt;/p&gt;</p>
										<div className="row">
											<div className="col-7">
												{/* Carausel Scroll */}
										...
										<Link href="assets/my-cv.pdf" className="btn me-2 text-300 ps-0 mt-4" target="_blank">
